...
$cart_button_attrs = [
	...
	'name'    => 'task',
	'value'   => 'cart.add',
//	'class'   => [ 'js-add-to-cart m-product-details_order_btn e-btn i-icon i-add-to-cart', $item_cart_btn_class ],
	'class'   => [ 'js-add-to-cart m-product-details_order_btn e-btn', $item_cart_btn_class ],
...
<?php if ($params->get('item_show_cart_btn', '1') == '1') : ?>
	<form class="m-product-details_order_form js-add-to-cart-form" action="<?php echo JRoute::_($form_action); ?>" method="post" enctype="multipart/form-data" >
		<button <?php echo implode(' ', $args); ?> >
			<i class="m-product-details_order_btn_icon"></i><span><?php echo $item_cart_btn_text; ?></span>
		</button>
