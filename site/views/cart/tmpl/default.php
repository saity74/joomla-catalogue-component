		...
		<form action="cart.html" method="POST" id="orderForm" class="cart-form form-validate">
			...
			<div class="form-wrapper white-box cart-form" id="cartForm">
				...
				<div class="form-lables">
					...
					<div class="controlls">
                        <textarea title="Подробный адрес доставки" placeholder="Подробный адрес доставки" class="field"
								  name="address"></textarea>
					</div>
					<div class="controlls">
                        <textarea title="Пожелания по доставке" placeholder="Пожелания по доставке" class="field"
								  name="desc"></textarea>
					</div>
				</div>
				<div>
