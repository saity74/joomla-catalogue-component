...
$menu = $this->menu;
?>
<div class="catalogue-<?php echo $view ?>-<?php echo $layout ?> row">
	<div class="span9">
					...
					<div class="form-wrapper">
						<div class="form-bg">
							<form action="<?php echo JRoute::_('index.php?option=com_catalogue'); ?>" method="POST"
								...
								<div>
									<a href="#" class="orange-btn order-send order-btn"
									   id="catFastOrder"><?php echo $params->get('cart_form_btn', 'Заказать') ?></a>
								</div>
