...
<form action="<?php echo JRoute::_('index.php?option=com_catalogue&view=catalogue'); ?>" method="post" name="adminForm"
	...
	<div id="j-sidebar-container" class="span2">
		...
		<?php
		// Search tools bar
		echo JLayoutHelper::render('filters', array('filters' => $this->filterForm->getGroup('filter')));
		?>
	</div>
					...
					<tr class="row<?php echo $i % 2; ?>" sortable-group-id="<?php echo $item->category_id ?>">
						<td class="order nowrap center hidden-phone">
							...
							<i class="icon-menu"></i>
								...
								<input title="" type="text" style="display:none" name="order[]" size="5"
						...
						<td class="hidden-phone">
							...
							{
								echo substr(strip_tags($item->item_description), 0, 100) . '...';
							} ?>
						</td>
						<td class="hidden-phone">
