 ...
 * @since  1.6
 */
class CatalogueViewPayments extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		{
			CatalogueHelper::addSubmenu('payments');
		}
	...
	{
		$canDo = JHelperContent::getActions('com_catalogue', 'payment', $this->state->get('filter.category_id'));
		$user  = JFactory::getUser();

		// Get the toolbar object instance
		$bar = JToolbar::getInstance('toolbar');

		JToolbarHelper::title(JText::_('COM_CATALOGUE_PAYMENTS_MANAGER_TITLE'), 'credit');
		...
		{
			JToolbarHelper::deleteList('JGLOBAL_CONFIRM_DELETE', 'payments.delete', 'JTOOLBAR_EMPTY_TRASH');
		}
