...
$function  = $app->input->getCmd('function', 'jSelectAttr');
$listOrder = $this->escape($this->state->get('list.ordering'));
$listDirn  = $this->escape($this->state->get('list.direction'));
?>
<form action="<?php echo JRoute::_(
		'index.php?option=com_catalogue&view=attrs&layout=modal&tmpl=component&function=' . $function . '&' . JSession::getFormToken() . '=1'
	...
	<fieldset class="filter">
		...
		<div class="filters">
			...
			<select name="filter_group_id" class="input-medium" onchange="this.form.submit()">
				<option value=""><?php echo JText::_('COM_CATALOGUE_FILTER_SELECT_ATTRGROUP');?></option>
				<?php echo JHtml::_('select.options', JHtml::_('catalogueadministrator.attrgroupsoptions',
					[
						'filter.language' => ['*', $this->state->get('filter.forcedLanguage')]
					]
				), 'value', 'text', $this->state->get('filter.group_id')); ?>
			</select>
			...
			<select name="filter_group_id" class="input-medium" onchange="this.form.submit()">
				...
				echo JHtml::_(
					'select.options',
					JHtml::_('catalogueadministrator.attrgroupsoptions'),
					'value', 'text',
