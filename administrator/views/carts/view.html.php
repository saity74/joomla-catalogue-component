...
JLoader::register('CatalogueHelper', JPATH_COMPONENT . '/helpers/_catalogue.php');
...
class CatalogueViewCarts extends JViewLegacy
{
	...
	protected function addToolbar()
	{
		...
		require_once JPATH_COMPONENT . '/helpers/_catalogue.php';

		$canDo = JHelperContent::getActions('com_catalogue', 'carts');

		JToolbarHelper::title(JText::_('COM_CATALOGUE_CARTS_MANAGER_TITLE'), 'cart');
